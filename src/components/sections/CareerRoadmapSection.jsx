                    ...
                    <div className="relative">
                        ...
                        <div className="glass-card p-6 md:p-8">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="px-2 py-0.5 text-[10px] font-medium tracking-widest uppercase rounded-full bg-white/[0.04] border border-white/[0.06] text-white/40">{item.type ? (t.roadmap.tags[item.type.toLowerCase()] || item.type) : item.type}</span>
                            </div>

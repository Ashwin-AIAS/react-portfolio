    ...
    <div className="w-full h-48 bg-black/50 relative overflow-hidden flex items-center justify-center">
        ...
        <div className="flex items-center gap-3">
            <div className="flex flex-col gap-1.5">
                {[0, 1, 2].map(i => (
                    <div key={i} className="rag-doc w-10 h-7 bg-cyan-900/60 border border-cyan-500/30 rounded flex items-center justify-center" style={{ animationDelay: `${i * 0.4}s` }}>
            ...
            <svg width="30" height="40" className="text-cyan-500/50 svg-dash-flow" style={{strokeDasharray: '4 2', strokeDashoffset: '12'}}><path d="M5 20 L25 20" stroke="currentColor" strokeWidth="2" /><polygon points="22,15 28,20 22,25" fill="currentColor"/></svg>
